...
| 섹션               | 주 책임 Agent             | 주요 산출물                        |
| ------------------ | ------------------------- | ---------------------------------- |
| SUMMARY            | Report_Compiler           | 핵심 문장, 스파크라인 썸네일       |
| 시장 개요          | Market_Researcher         | 판매/보급률 표, 트렌드 서술 + 증거 |
| 수요·가격          | Market_Researcher         | ASP/판매 상관, 가격 타임라인       |
| 정책 Watch         | Market_Researcher         | 보조금 표, 정책 타임라인           |
| 배터리·공급망      | Company_Analyzer(+Market) | 케미스트리/원가/캐파 표·그래프     |
| 경쟁·지역          | Company_Analyzer          | 포지셔닝, 지역 Top 모델            |
| 시사점             | Supervisor(+모든)         | 액션 리스트                        |
| REFERENCE/APPENDIX | Report_Compiler           | 각주 집계, 방법론·지표 정의        |
