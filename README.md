...
- **핵심 질문**: 침체/조정의 **구조적 vs 단기** 요인 및 지역별 온도차 동향은?
- **필수 표/차트**
...
- **필수 표/차트**
  - 세그먼트별 점유율, 판매가 vs 판매량 산점도, 주요 OEM 가격 인하 타임라인
- **체크**: 가격 변화 ↔ 판매량 상관, 믹스 효과 분리 메모.

### 4) 정책·규제

- **핵심 질문**: 전기차 관련 정책 규제(IRA(인플레이션 감축법), 유럽의 탄소 규제, 중국의 보조금 축소 등)가 **수요·공급망·가격** 경로에 미친 영향은?
- **필수 표/차트**
...
- **핵심 질문**: LFP/LMFP/4680/SSB 전환 속도와 **원가/성능 트레이드오프**, 주요 벤더 생산능력 변화는?
- **필수 표/차트**
...
- **내용**: 지표 정의서(판매·보급률·ASP·원가 산식), 스냅샷 기준/버전, 데이터 정합성 검증 기준(날짜·수치 정합성 규칙)
